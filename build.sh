...
x86_64-linux-gnu-ld -m elf_i386 -T kernel/linker.ld kernel_entry.o interrupts.o idt.o pic.o pmm.o kmalloc.o libc.o syscalls_posix.o kernel_main.o -o kernel.elf
