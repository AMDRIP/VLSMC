...
- **Общие ресурсы [РЕАЛИЗОВАНО]**: Дескрипторы открытых файлов и каналы IPC должны наследоваться и увеличивать счетчик ссылок (VFS Refcount).
